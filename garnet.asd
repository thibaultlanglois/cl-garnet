...
(defsystem garnet/opal-boot
  :pathname "src/opal"
  :depends-on (garnet/utils garnet/kr)
  :components
  ((:file "exports")
   (:file "types")
...
(defsystem garnet/gem
  :pathname "src/gem"
  :depends-on (garnet/kr garnet/opal-boot)
  :components
  ((:file "gem")
   (:file "define-methods")
   (:file "x")))
...
(defsystem garnet/opal
  :pathname "src/opal"
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal-boot)
  :components
  ((:file "text-functions")
   (:file "text")
   (:file "update-basics")
...
(defsystem garnet/inter
  :pathname "src/inter"
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal)
  :components
...
(defsystem garnet/ps
  :pathname "src/ps"
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/inter)
  :components
  ((:file "ps-compiler")
   (:file "ps")
   (:file "ps-multifont")))
...
(defsystem garnet/aggregadgets
  ...
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/inter garnet/ps)
  :components
  (;; asdf way of loading files makes the aggregadget-compiler/loader
   ;; unnecessary. 
...
(defsystem garnet/gadgets
  ...
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/inter garnet/ps garnet/aggregadgets)
  :components
...
(defsystem garnet/motif-gadgets
  :pathname "src/gadgets"
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/inter garnet/ps garnet/aggregadgets)
  :components
  (;; (:file "gadgets-compiler")
...
(defsystem garnet/debug
  :pathname "src/debug"
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/ps garnet/gadgets)
  :components
  ((:file "debug-fns")
   (:file "objsize")
   (:file "inspector")
...
(defsystem garnet/protected-eval
  ...
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/ps garnet/gadgets garnet/debug)
  :components
...
(defsystem garnet/demos
  :pathname "src/demos"
  :depends-on (garnet/utils garnet/gem garnet/kr garnet/opal garnet/ps garnet/gadgets
                            garnet/motif-gadgets  garnet/protected-eval
		            ;; garnet/gesture
                            )
  :components
  ((:file "demos")
   (:file "demo-3d")
   (:file "demo-angle")
   ;; (:file "demo-animator") depends in bitmaps loaded at compile time.
   ;; (:file "demo-arith") depends on gestures
   (:file "demo-array")
   (:file "garnet-calculator")
   (:file "demo-virtual-agg")
   (:file "demo-clock")
   ;; (:file "demo-editor") depends on garnet-load
   ;; (:file "demo-file-browser") idem
   ;; (:file "demo-gadgets") idem
   ;; (:file "demo-gesture") depends on garnet-load
   ;; (:file "demo-graph") depends on aggregraph-loader
   ;; (:file "demo-grow") depends on garnet-load
   (:file "demo-logo")
   (:file "demo-manyobjs")
   ;; (:file "demo-menu") depends on garnet-load
   (:file "demo-mode")
   (:file "demo-motif")
   (:file "demo-moveline")
   ;; (:file "demo-multifont") depends on garnet-load
   (:file "demo-multiwin")
   ;; (:file "demo-pixmap") depends on garnet-load
   ...
   ;; (:file "demo-othello")
   (:file "demo-xasperate")
   ;; (:file "demo-unistrokes") depends on gestures
   (:file "garnetdraw")
...
(defsystem :garnet
  :depends-on (cl-fad
	       clx
               ...
               garnet/gadgets
               garnet/debug
               ;; not included because it depends on motif gadgets
...
;;; Modules not used at the moment:
#+nil
(:module gesture
